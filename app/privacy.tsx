...
const SECTIONS = [
  ...
  },
  {
    ...
    text: 'Данные используются исключительно для работы программы лояльности САТОРИ. Мы не передаём ваши данные третьим лицам и не используем их в рекламных целях без вашего согласия.',
  },
  {
