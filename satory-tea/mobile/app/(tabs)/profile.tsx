...
export default function ProfileScreen() {
  ...
  const progress = Math.min(user.bonus_points / maxPoints, 1);
  const toGold = Math.max(0, 1000 - user.bonus_points);
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.userCard}>
        ...
        <View style={styles.statsRow}>
          {[
            ...
            { icon: 'gift-outline', value: user.bonus_points, label: 'Бонусов' },
          ].map((s, i) => (
      ...
      <View style={styles.bonusCard}>
        <View style={styles.bonusHeader}>
          <Text style={styles.bonusTitle}>{user.bonus_points} бонусных баллов</Text>
